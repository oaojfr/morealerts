...
/**
 * Class PluginMorealertsNotificationState
 */
class PluginMorealertsNotificationState extends CommonDBTM {
   ...
   public function getSpecificMassiveActions($checkitem = null) {
      ...
      $actions['PluginMorealertsNotificationState' . MassiveAction::CLASS_ACTION_SEPARATOR . 'purge'] = __('Delete');
