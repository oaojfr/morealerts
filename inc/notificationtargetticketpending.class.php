...
class PluginMorealertsNotificationTargetTicketPending extends NotificationTarget {

   static $rightname = "plugin_morealerts";

   function getEvents() {
      return ['ticketpending' => PluginMorealertsTicketPending::getTypeName(2)];
   }
   ...
   function addDataForTemplate($event, $options = []) {
      $ticket = new Ticket();
      $ticket->getEmpty();
      $notificationTargetTicket = NotificationTarget::getInstance($ticket, 'ticketpending', $options);
