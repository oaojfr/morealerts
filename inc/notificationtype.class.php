...
/**
 * Class PluginMorealertsNotificationType
 */
class PluginMorealertsNotificationType extends CommonDBTM {
   ...
   public function getSpecificMassiveActions($checkitem = null) {
      ...
      $actions['PluginMorealertsNotificationType' . MassiveAction::CLASS_ACTION_SEPARATOR . 'purge'] = __('Delete');
