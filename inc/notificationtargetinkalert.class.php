...
/**
 * Class PluginMorealertsNotificationTargetInkAlert
 */
class PluginMorealertsNotificationTargetInkAlert extends NotificationTarget {

   /**
    * @return array
    */
   function getEvents() {
      return ['ink' => __('Cartridges whose level is low', 'morealerts')];
   }
   ...
   function getTags() {
      ...
      $this->addTagToList(['tag'     => 'morealerts',
                           'label'   => __('Cartridges whose level is low', 'morealerts'),
                           'value'   => false,
                           'foreach' => true,
                           'events'  => ['ink']]);
