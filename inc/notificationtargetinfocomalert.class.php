...
/**
 * Class PluginMorealertsNotificationTargetInfocomAlert
 */
class PluginMorealertsNotificationTargetInfocomAlert extends NotificationTarget
{
    ...
    */
   function getEvents() {
      return ['notinfocom' => PluginMorealertsInfocomAlert::getTypeName(2)];
   }
   ...
   function getTags() {
      ...
      $this->addTagToList(['tag' => 'morealerts',
         'label' => PluginMorealertsInfocomAlert::getTypeName(2),
         'value' => false,
         'foreach' => true,
         'events' => ['notinfocom']]);
